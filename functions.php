...
function ellak_social_links() { ?>
	<div class="header-login">
				...
				<a href="<?php echo esc_url( get_edit_user_link() ); ?>"><?php _e( 'Ο λογαριασμός μου', 'ellak15' ); ?></a>
				<a href="<?php echo esc_url( wp_logout_url( get_permalink() ) ); ?>"><?php _e( 'Αποσύνδεση', 'ellak15' ); ?></a>

				<?php else:

					if( get_option( 'users_can_register' ) ): ?>
				<a href="<?php echo esc_url( wp_registration_url() ); ?>"><?php _e( 'Εγγραφή', 'ellak15' ); ?></a>
				<?php	endif; // get_option ?>

				<a href="<?php echo esc_url( wp_login_url() ); ?>"><?php _e( 'Συνδεση', 'ellak15' ); ?></a>
...
function ellak_credits() {
	echo __( '<a href="https://mathe.ellak.gr/" target="_blank">Υλοποίηση με χρήση του Ανοικτού Λογισμικού</a>', 'ellakgr' )
		. ' <a href="https://wordpress.org/" target="_blank">Wordpress</a> | '
		. '<a href="https://ellak.gr/ori-chrisis" target="_blank">'
		. __( 'Όροι Χρήσης & Δήλωση Απορρήτου', 'ellakgr' ) . '</a> | '
		. __( 'Άδεια χρήσης περιεχομένου:', 'ellakgr' )
